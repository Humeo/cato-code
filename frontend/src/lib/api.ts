import type { Stats, Repo, Activity, ActivityLog, DashboardPayload, CurrentUser } from "./types";
...
export async function getMe(init?: RequestInit): Promise<CurrentUser | null> {
  return apiFetch<CurrentUser>("/api/me", init);
}
